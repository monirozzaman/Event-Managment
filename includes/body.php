<body>
  ...
  ?>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/cs04.jpg');">
    		...
    		<div class="row">
    			<div class="col-md-12">
    				<div class="single-slider owl-carousel ftco-animate">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/cs04.jpg);">
